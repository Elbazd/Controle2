...
double Millions = 150;
double Benefice = 31;
double Inférieur = 0.8;
double NombresAnnées = 0;
double Compt = 0;
while (Compt <= Millions){
Compt = Compt + Benefice ;
Benefice = Benefice * Inférieur; 
NombresAnnées++;
} 
lblNbSemaines.setText(" Le stade sera bénéficiaire au bout de " + NombresAnnées + " années");
...
JOptionPane.showMessageDialog(this, "Veuillez saisir le nombres de bugs résolus");
} 
if(txtNbAnnees.getText().compareTo("")==0){
JOptionPane.showMessageDialog(this, "Veuillez saisir le nombre d'années");
}   
else{
Prime=Integer.parseInt(txtNbBugs.getText())*0.04;
if(Prime>400){
Prime=400;
}
if ((Integer.parseInt(txtNbAnnees.getText())>4)){
int i=0;
Année=(Integer.parseInt(txtNbAnnees.getText())-4);
while (i <Année){
Ancienneté=Ancienneté+30;
}  
}
double Total=Prime+Ancienneté;
lblPrime.setText(String.valueOf("Votre prime totale est de :"+" "+Total+" "+"€"));
}
